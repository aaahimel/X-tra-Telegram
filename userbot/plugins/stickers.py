...
async def _(event):
    ...
    await event.edit(f"**Bingo!** `This sticker has been kAnGed to` [this place](t.me/addstickers/{packshortname}), pack{pack}"
                     f" `by` {DEFAULTUSER}\n**ᕦ(ò_óˇ)ᕤ**")
