...
async def _(event):
    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         ONE = ("__Okay. Your request has been registered. Do not spam my master's inbox.You can expect a reply within few hours. He is a busy man, unlike you probably.__\n\n"
         ...
         FIVE = ("`Okay. please have the basic manners as to not bother my master too much. If he wishes to contact you, he will respond to you soon.`\n**Do not ask repeatdly else you will be blocked and reported.**")
